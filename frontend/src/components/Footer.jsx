                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-1">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <span className="text-lg font-bold tracking-tight text-white">Mkwise Financial</span>
                        </div>
                        <p className="text-sm leading-relaxed mb-6">
                            Providing professional mortgage and protection advice across the United Kingdom.
                        </p>
                        <div className="flex gap-4">
                            <a className="hover:text-primary transition-colors cursor-pointer" href="#"><span className="material-icons text-xl text-[inherit]">facebook</span></a>
                            <a className="hover:text-primary transition-colors cursor-pointer" href="#"><span className="material-icons text-xl text-[inherit]">alternate_email</span></a>
                        </div>
                    </div>
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <li><Link className="hover:text-primary transition-colors" to="/mortgages/buy-to-let">Buy to Let</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <li><a className="hover:text-primary transition-colors cursor-pointer" href="#">Privacy Policy</a></li>
                            <li><a className="hover:text-primary transition-colors cursor-pointer" href="#">Terms of Service</a></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <p className="text-sm mb-2">0800 123 4567</p>
